      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-blue-900 max-w-2xl mx-auto">
            Have questions or feedback? We'd love to hear from you! Reach out through any of the methods below.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-blue-800 mb-1">Phone</h3>
                  <a href="tel:+919718659236" className="text-blue-900 hover:text-blue-600 transition">
                    +91 9718659236
                  </a>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:ankitroy5575@gmail.com" className="text-blue-900 hover:text-blue-600 transition">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-blue-800 mb-1">Office</h3>
                  <p className="text-blue-900">Crack_IQ Education Pvt. Ltd.</p>
                  <p className="text-blue-900">123 Knowledge Park</p>
                  <p className="text-blue-900">New Delhi, Delhi 110001</p>
                  <p className="text-blue-900">India</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-blue-800 mb-1">WhatsApp</h3>
                  <a 
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full px-6 py-3 bg-blue-800 hover:bg-blue-700 text-white font-medium rounded-md transition"
              >
                Send Message
              </motion.button>
            </form>
        ...
        >
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.566477893165!2d77.2098653150823!3d28.61390098242695!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce2daa9db4d07%3A0xad4f6c9cf4b5f5e!2sConnaught%20Place%2C%20New%20Delhi%2C%20Delhi!5e0!3m2!1sen!2sin!4v1629876543210!5m2!1sen!2sin"
            width="100%"
            height="400"
            style={{ border: 0 }}
            allowFullScreen=""
            loading="lazy"
            title="Crack_IQ Office Location"
          ></iframe>
        </motion.div>
      </div>
    </div>
